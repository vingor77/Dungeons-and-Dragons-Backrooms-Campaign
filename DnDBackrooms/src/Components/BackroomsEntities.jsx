...
/* Paste here. Once all are done, move it to database
{
  ...
  "Creatures.Mangled":{"Id":"Mangled","Name":"Mangled","Path":"","Link":"https://ebshimizu.github.io/5emm/","SearchHint":"Mangled\nmonstrosity\nchaotic evil","FilterDimensions":{"Level":"10","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Large monstrosity, chaotic evil"},"LastUpdateMs":0,"Version":"1.0.0","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Large monstrosity, chaotic evil","HP":{"Value":212,"Notes":"(25d10+75)"},"InitiativeModifier":2,"InitiativeAdvantage":false,"Speed":["walk 60 ft."],"AC":{"Value":17,"Notes":"Natural armor"},"Abilities":{"Str":21,"Dex":14,"Con":16,"Int":5,"Wis":7,"Cha":3},"Saves":[],"DamageVulnerabilities":["slashing"],"DamageResistances":[],"DamageImmunities":["cold","psychic"],"ConditionImmunities":["grappled","incapacitated","deafened","charmed"],"Skills":[],"Senses":["truesight 60 ft.","passive Perception 8"],"Languages":[""],"Challenge":"10","Traits":[{"Name":"Free-clip","Content":"The Mangled can no-clip through anything at will."},{"Name":"Limited Vision","Content":"The Mangled cannot see past 60 feet."},{"Name":"Viscous ","Content":"The Mangled attacks anything within its range, including other Mangled and entities."},{"Name":"Quad-jointed limbs","Content":"The Mangled can bend its limbs in virtually any way, sometimes mangling itself together."}],"Actions":[{"Name":"Multiattack","Content":"Mangled uses the Wrap and lift action one time followed by one Stomp attack or makes two Stomp attacks. Note: The stomp goes first always."},{"Name":"Bite","Content":"Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 41 (8d8+5) piercing damage plus 18 (4d8) poison damage. "},{"Name":"Stomp","Content":"Melee Weapon Attack: +7 to hit, reach 30 ft., one target. Hit: 32 (5d10+5) bludgeoning damage. "},{"Name":"Wrap and lift","Content":"The Mangled attempts to grab a target. The target must succeed on a DC 16 Dexterity saving throw or be grappled and pulled towards the Mangled's face. The Mangled may only have one target grappled at any time."},{"Name":"Windy scream","Content":"The Mangled makes a painful scream that sounds similar to excessive wind. Any creatures within 60 ft. of the Mangled must make a DC 16 Constitution saving throw or take 4d6 (14) psychic damage and lose 2 sanity, or half as much damage and sanity on a pass."}],"LegendaryActions":[],"Reactions":[],"Description":"","Player":"","ImageURL":""},
  "Creatures.Wallpaper-Wraith":{"Id":"Wallpaper-Wraith","Name":"Wallpaper Wraith","Path":"","Link":"https://ebshimizu.github.io/5emm/","SearchHint":"Wallpaper Wraith\nbeast\nneutral","FilterDimensions":{"Level":"5","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Medium beast, neutral"},"LastUpdateMs":0,"Version":"1.0.0","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Medium beast, neutral","HP":{"Value":136,"Notes":"(13d8+78)"},"InitiativeModifier":4,"InitiativeAdvantage":false,"Speed":["walk 20 ft.","climb 20 ft."],"AC":{"Value":15,"Notes":""},"Abilities":{"Str":6,"Dex":18,"Con":22,"Int":17,"Wis":12,"Cha":10},"Saves":[],"DamageVulnerabilities":["thunder"],"DamageResistances":[],"DamageImmunities":["acid"],"ConditionImmunities":[],"Skills":[{"Name":"Perception","Modifier":7}],"Senses":["darkvision 30 ft.","passive Perception 17"],"Languages":[""],"Challenge":"5","Traits":[{"Name":"Sensitive Hearing","Content":"The Wallpaper Wraith may die when it hears a loud noise. The Wallpaper Wraith must make a DC 14, 18, 22, or 26 Constitution saving throw or die, based on how loud the sound is."},{"Name":"Perfect Stealth","Content":"The Wallpaper Wraith while out of combat cannot be detected by most means as it blends with its surroundings perfectly. True sight and motion detectors can see through this."}],"Actions":[{"Name":"Tongue Whip","Content":"Melee or Ranged Weapon Attack: +6 to hit, reach 5 ft. or range 10/30 ft., one target. Hit: 13 (3d8) acid damage plus 9 (2d8) slashing damage. The target is becomes mute for the next minute."}],"LegendaryActions":[],"Reactions":[{"Name":"Spit","Content":"Whenever the Wallpaper Wraith is harmed, it spits a blackened liquid at the attacker. The target must make a DC 15 saving throw or become stunned for 1 minute. During this time, the target has vulnerability to Acid damage. The target may repeat this saving throw at the end of each of its turns."}],"Description":"","Player":"","ImageURL":""},
  "Creatures.Shocker-Ghul":{"Id":"Shocker-Ghul","Name":"Shocker Ghul","Path":"","Link":"https://ebshimizu.github.io/5emm/","SearchHint":"Shocker Ghul\nUndead\nneutral evil","FilterDimensions":{"Level":"1/4","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Medium Undead, neutral evil"},"LastUpdateMs":0,"Version":"1.0.0","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Medium Undead, neutral evil","HP":{"Value":22,"Notes":"(3d8+9)"},"InitiativeModifier":-2,"InitiativeAdvantage":false,"Speed":["walk 20 ft."],"AC":{"Value":8,"Notes":""},"Abilities":{"Str":13,"Dex":6,"Con":16,"Int":3,"Wis":6,"Cha":5},"Saves":[{"Name":"Wis","Modifier":0}],"DamageVulnerabilities":[],"DamageResistances":["lightning","thunder"],"DamageImmunities":[],"ConditionImmunities":["poisoned"],"Skills":[],"Senses":["darkvision 60 ft.","passive Perception null"],"Languages":["understands the languages it knew in life but can't speak"],"Challenge":"1/4","Traits":[{"Name":"Undead Fortitude","Content":"If damage reduces the zombie to 0 hit points, it must make a Constitution saving throw with a DC of 5+the damage taken, unless the damage is radiant or from a critical hit. On a success, the zombie drops to 1 hit point instead."}],"Actions":[{"Name":"Shock","Content":"Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 4 (1d6+1) lightning damage.  "}],"LegendaryActions":[],"Reactions":[],"Description":"","Player":"","ImageURL":""},
  "Creatures.Wrangler":{"Id":"Wrangler","Name":"Wrangler","Path":"","Link":"https://ebshimizu.github.io/5emm/","SearchHint":"Wrangler\nmonstrosity\nunaligned","FilterDimensions":{"Level":"3","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Gargantuan monstrosity, unaligned"},"LastUpdateMs":0,"Version":"1.0.0","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Gargantuan monstrosity, unaligned","HP":{"Value":100,"Notes":"(8d20+16)"},"InitiativeModifier":3,"InitiativeAdvantage":false,"Speed":["burrow 40 ft."],"AC":{"Value":13,"Notes":""},"Abilities":{"Str":20,"Dex":17,"Con":14,"Int":7,"Wis":18,"Cha":12},"Saves":[],"DamageVulnerabilities":[],"DamageResistances":[],"DamageImmunities":[],"ConditionImmunities":[],"Skills":[],"Senses":["tremorsense 60 ft.","passive Perception 14"],"Languages":[""],"Challenge":"3","Traits":[{"Name":"Split","Content":"Whenever The Wrangler hits 50% maximum health or lower, it splits into two smaller Wranglers with 50 maximum health, does half damage (factored into below), and is of size Large. The weaker splits do not have this trait."}],"Actions":[{"Name":"Burst","Content":"The Wrangler bursts from the ground. Any creature within a 15 ft. radius from the Wrangler must make a DC 13 saving throw or take 6d6 + 5 (Full) or 3d6 + 2 (Half) piercing damage as it bites the area. This may only be used while the Wrangler is burrowed."},{"Name":"Burrow","Content":"The Wrangler moves up to its speed underground."},{"Name":"Hypnotize","Content":"The Wrangler uses its body to hypnotize creatures. Whenever the Wrangler is looked at, the creature must make a DC 13 Charisma saving throw or be charmed for 1 minute or until damage is taken. The creature may make this saving throw again at the end of each of its turns. Once affected, the creature is immune to this effect for 1d4 hours."}],"LegendaryActions":[],"Reactions":[],"Description":"","Player":"","ImageURL":""},
  "Creatures.Hen":{"Id":"Hen","Name":"Hen","Path":"","Link":"https://ebshimizu.github.io/5emm/","SearchHint":"Hen\nmonstrosity\nneutral","FilterDimensions":{"Level":"1/4","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Small monstrosity, neutral"},"LastUpdateMs":0,"Version":"1.0.0","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Small monstrosity, neutral","HP":{"Value":44,"Notes":"(8d6+16)"},"InitiativeModifier":0,"InitiativeAdvantage":false,"Speed":["walk 30 ft."],"AC":{"Value":13,"Notes":""},"Abilities":{"Str":15,"Dex":10,"Con":14,"Int":13,"Wis":6,"Cha":10},"Saves":[],"DamageVulnerabilities":[],"DamageResistances":[],"DamageImmunities":[],"ConditionImmunities":[],"Skills":[],"Senses":["passive Perception 8"],"Languages":[""],"Challenge":"1/4","Traits":[{"Name":"Protective","Content":"The Hen is aggressive to any creature within 30 feet of it's eggs. The Hen is also aggressive to Clumps."}],"Actions":[{"Name":"Bite","Content":"Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 5 (1d6+2) slashing damage. "}],"LegendaryActions":[],"Reactions":[],"Description":"","Player":"","ImageURL":""},
  "Creatures.Reality-Bugs-(Swarm)":{"Id":"Reality-Bugs-(Swarm)","Name":"Reality Bugs (Swarm)","Path":"","Link":"https://ebshimizu.github.io/5emm/","SearchHint":"Reality Bugs (Swarm)\nmonstrosity\nneutral","FilterDimensions":{"Level":"3","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Large monstrosity, neutral"},"LastUpdateMs":0,"Version":"1.0.0","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Large monstrosity, neutral","HP":{"Value":110,"Notes":"(20d10+0)"},"InitiativeModifier":0,"InitiativeAdvantage":false,"Speed":["walk 30 ft.","fly 30 ft."],"AC":{"Value":13,"Notes":""},"Abilities":{"Str":10,"Dex":10,"Con":10,"Int":10,"Wis":10,"Cha":10},"Saves":[],"DamageVulnerabilities":[],"DamageResistances":[],"DamageImmunities":[],"ConditionImmunities":[],"Skills":[],"Senses":["passive Perception 10"],"Languages":[""],"Challenge":"3","Traits":[{"Name":"Mostly passive","Content":"The Reality Bugs are harmless to wanderers unless the nest is threatened or the wanderers are caught in a war between two sets of Reality Bugs."}],"Actions":[{"Name":"Consume","Content":"The Reality Bugs eat through reality, taking part of a level with it and leaving a void behind. Any creature within 30 ft. of the void created must make a DC 13 Dexterity saving throw or be sucked into the void. While within the void, each turn take 14 (4d6) psychic damage and lose 5 sanity. The creature may make a DC 13 Acrobatics or Athletics check to escape the void at the end of each of its turns."}],"LegendaryActions":[],"Reactions":[],"Description":"","Player":"","ImageURL":""},
  "Creatures.The-Keymaster":{"Id":"The-Keymaster","Name":"The Keymaster","Path":"","Link":"https://ebshimizu.github.io/5emm/","SearchHint":"The Keymaster\nhumanoid\nchaotic good","FilterDimensions":{"Level":"30","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Medium humanoid, chaotic good"},"LastUpdateMs":0,"Version":"1.0.0","Source":"Homebrew (Falindrith's Monster Maker)","Type":"Medium humanoid, chaotic good","HP":{"Value":532,"Notes":"(56d8+280)"},"InitiativeModifier":0,"InitiativeAdvantage":false,"Speed":["walk 30 ft."],"AC":{"Value":19,"Notes":""},"Abilities":{"Str":18,"Dex":10,"Con":21,"Int":27,"Wis":24,"Cha":18},"Saves":[{"Name":"Int","Modifier":17}],"DamageVulnerabilities":["radiant","force"],"DamageResistances":[],"DamageImmunities":["psychic","poison"],"ConditionImmunities":[],"Skills":[],"Senses":["blindsight 60 ft.","darkvision 60 ft.","truesight 60 ft.","passive Perception 17"],"Languages":[""],"Challenge":"30","Traits":[{"Name":"Access","Content":"The Keymaster has access to all levels."},{"Name":"Control","Content":"The Keymaster can lock and unlock levels."},{"Name":"Free-Clip","Content":"The Keymaster can no-clip at will within the same level."},{"Name":"Hidden Power","Content":"The Keymaster is hiding an incredible and sinister power behind his humanoid form. Upon reaching 0 health, The Keymaster transforms into Kei, a chaotic evil abomination with 6 tentacles, at full health. This unlocks new abilities labelled with [Transformed] in it."},{"Name":"Maddening Sight [Transformed]","Content":"The first time a creature glimpses at Kei, the creature must succeed on a DC 23 Wisdom Saving throw or instantly drop to 0 sanity."},{"Name":"Infinite Revival","Content":"The Keymaster returns to life after dying 1d8 days later on a random level with little to no memories of the encounter that killed him. This revival will not occur if slain by a god-killing weapon."},{"Name":"Legendary Resistance (1/Day)","Content":"If the Keymaster fails a saving throw, it can choose to succeed instead."}],"Actions":[{"Name":"Multiattack","Content":"The Keymaster makes three Stab attacks or makes six Whip [Transformed] attacks. "},{"Name":"Stab","Content":"Melee Weapon Attack: +14 to hit, reach 5 ft., one target. Hit: 74 (12d10+8) psychic damage. "},{"Name":"Whip [Transformed]","Content":"Melee Weapon Attack: +14 to hit, reach 5 ft., one target. Hit: 39 (10d6+4) slashing damage. "},{"Name":"Banish","Content":"The Keymaster mutters a word into a key and throws it towards a creature. The target must succeed on a DC 23 Charisma saving throw or be banished to level HELP for 1 minute. The target may make a DC 23 minus turns passed Charisma saving throw to escape the banishment at the end of each of its turns. Only 1 creature can be banished at a time."},{"Name":"Expand Mind","Content":"The Keymaster places his thumb onto a target's head and attempts to enlighten it to the truth of the world. The target must succeed on a DC 23 Wisdom saving throw or take 21 (6d6) psychic damage now and at the beginning of each of its turns and become feebleminded except the save may be remade at the end of each of its turns. Once The Keymaster has attempted and/or succeeded in expanding a target's mind, the target is immune to this effect permanently."},{"Name":"Access Mind","Content":"The Keymaster attempts to access the mind of a target. The target must succeed on a DC 23 Wisdom saving throw or be under an effect similar to the Crown of Madness spell except it loses 5 sanity at the beginning of each of its turns."},{"Name":"No-Clip","Content":"As a bonus action, The Keymaster may no-clip up to 60 feet in any direction without granting attacks of opportunity."}],"LegendaryActions":[{"Name":"Whip [Transformed]","Content":"The Keymaster makes a Whip [Transformed] attack."},{"Name":"No-Clip","Content":"The Keymaster uses the No-Clip action."}],"Reactions":[{"Name":"Deny","Content":"The Keymaster denies entry to his personal space. Any 1 attack automatically misses. This is decided after an attack hits but before damage is calculated."}],"Description":"","Player":"","ImageURL":""}
}
*/